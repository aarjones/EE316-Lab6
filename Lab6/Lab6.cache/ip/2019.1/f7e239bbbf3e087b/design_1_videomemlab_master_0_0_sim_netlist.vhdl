...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_videomemlab_master_v1_0_M00_AXI is
  ...
  attribute SOFT_HLUTNM of \current_char[3]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \current_char[4]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \current_char[6]_i_2\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \current_char[6]_i_3\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of extended_i_2 : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of \mst_exec_state[1]_i_6\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \mst_exec_state[1]_i_8\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \mst_exec_state[2]_i_3\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \mst_exec_state[2]_i_4\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of start_single_read_i_2 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of start_single_write_i_3 : label is "soft_lutpair7";
begin
...
\mst_exec_state[0]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0070"
    )
        port map (
...
\mst_exec_state[1]_i_7\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FF7F"
    )
        port map (
...
\mst_exec_state[2]_i_6\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FB"
    )
        port map (
