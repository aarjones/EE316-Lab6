...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_char8x12_lookup_table is
  port (
    ...
    \reg_pixels_reg[0]\ : in STD_LOGIC_VECTOR ( 5 downto 0 );
    \reg_pixels_reg[0]_0\ : in STD_LOGIC;
    Q : in STD_LOGIC_VECTOR ( 1 downto 0 );
    \current_char[6]_i_5\ : in STD_LOGIC;
...
bram1: unisim.vcomponents.RAMB18E1
    generic map(
      ...
      ADDRARDADDR(11 downto 7) => \reg_pixels_reg[0]\(4 downto 0),
      ADDRARDADDR(6 downto 0) => B"0110111",
...
bram1_i_2: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00004540"
        ...
        port map (
      I0 => Q(1),
      I1 => \current_char[6]_i_5\,
      I2 => Q(0),
      I3 => \current_char[6]_i_5_0\,
      I4 => ctrl,
      O => \^ascii\(1)
    );
bram1_i_3: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00004540"
        ...
        port map (
      I0 => Q(1),
      I1 => \current_char[6]_i_5_1\,
      I2 => Q(0),
      I3 => \current_char[6]_i_5_2\,
      I4 => ctrl,
      O => \^ascii\(0)
    );
...
\mst_exec_state_reg[2]_i_8\: unisim.vcomponents.MUXF7
     port map (
      I0 => bram1_i_14_n_0,
      I1 => bram1_i_15_n_0,
      O => \^code_reg[1]_4\,
...
\mst_exec_state_reg[2]_i_9\: unisim.vcomponents.MUXF7
     port map (
      I0 => bram1_i_26_n_0,
      I1 => bram1_i_27_n_0,
      O => \code_reg[1]_0\,
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_videomemlab_master_v1_0_M00_AXI is
  ...
  signal Inst_scancode_ascii_n_18 : STD_LOGIC;
  ...
  signal ctrl_r_down_i_3_n_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of alt_i_4 : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of alt_i_5 : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of alt_r_down_i_3 : label is "soft_lutpair9";
  ...
  attribute SOFT_HLUTNM of ctrl_r_down_i_2 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of ctrl_r_down_i_3 : label is "soft_lutpair16";
  ...
  attribute SOFT_HLUTNM of \current_char[4]_i_2\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \current_char[5]_i_2\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \current_char[6]_i_11\ : label is "soft_lutpair12";
  ...
  attribute SOFT_HLUTNM of \current_char[6]_i_4\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \current_char[6]_i_6\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \current_char[6]_i_7\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \current_line[3]_i_2\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \current_line[4]_i_2\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \current_line[5]_i_4\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \current_line[5]_i_8\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \current_line[5]_i_9\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of extended_i_1 : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of keyup_i_1 : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \mst_exec_state[0]_i_2\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \mst_exec_state[1]_i_5\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \mst_exec_state[2]_i_7\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of read_issued_i_2 : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of shift_i_2 : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of shift_i_5 : label is "soft_lutpair13";
begin
...
Inst_char_lookup: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_char8x12_lookup_table
     port map (
      ...
      ctrl => ctrl,
      \current_char[6]_i_5\ => Inst_scancode_ascii_n_15,
      \current_char[6]_i_5_0\ => Inst_scancode_ascii_n_14,
      \current_char[6]_i_5_1\ => Inst_scancode_ascii_n_18,
      \current_char[6]_i_5_2\ => Inst_scancode_ascii_n_17,
      m00_axi_aclk => m00_axi_aclk,
      m00_axi_aresetn => m00_axi_aresetn,
      \reg_pixels_reg[0]\(5) => ascii(7),
      \reg_pixels_reg[0]\(4 downto 0) => ascii(4 downto 0),
...
Inst_scancode_ascii: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_scancode2ascii
     port map (
      \code_reg[1]\ => Inst_scancode_ascii_n_6,
      \code_reg[1]_0\ => Inst_scancode_ascii_n_7,
      \code_reg[1]_1\ => Inst_scancode_ascii_n_8,
      \code_reg[1]_2\ => Inst_scancode_ascii_n_9,
      \code_reg[1]_3\ => Inst_scancode_ascii_n_10,
      \code_reg[1]_4\ => Inst_scancode_ascii_n_12,
      \code_reg[1]_5\ => Inst_scancode_ascii_n_14,
      \code_reg[1]_6\ => Inst_scancode_ascii_n_15,
      \code_reg[1]_7\ => Inst_scancode_ascii_n_17,
      \code_reg[1]_8\ => Inst_scancode_ascii_n_18,
      \code_reg[6]\(4 downto 0) => ascii(4 downto 0),
      \code_reg[6]_0\ => Inst_scancode_ascii_n_5,
      \code_reg[6]_1\ => Inst_scancode_ascii_n_11,
      \code_reg[6]_2\ => Inst_scancode_ascii_n_13,
      \code_reg[6]_3\ => Inst_scancode_ascii_n_16,
...
alt_i_5: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
...
alt_r_down_i_3: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
ctrl_i_1: unisim.vcomponents.LUT2
    generic map(
      ...
      I1 => ctrl_l_down_i_1_n_0,
      O => ctrl0
    );
ctrl_l_down_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFDFFF00001000"
    )
        port map (
      I0 => keyup_reg_n_0,
      I1 => ctrl_r_down_i_3_n_0,
      I2 => m00_axi_rdata(2),
      I3 => ctrl_r_down_i_2_n_0,
      I4 => extended_reg_n_0,
      I5 => ctrl_l_down_reg_n_0,
...
ctrl_r_down_i_1: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => m00_axi_rdata(2),
      I3 => extended_reg_n_0,
      I4 => ctrl_r_down_i_3_n_0,
      I5 => keyup_reg_n_0,
      O => ctrl_r_down_i_1_n_0
    );
ctrl_r_down_i_2: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000100"
    )
        port map (
...
ctrl_r_down_i_3: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\current_line[5]_i_10\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000000FF00E2"
        ...
        port map (
      I0 => Inst_scancode_ascii_n_17,
      I1 => sel0(6),
      I2 => Inst_scancode_ascii_n_18,
      I3 => ctrl,
      I4 => Inst_scancode_ascii_n_13,
      I5 => sel0(7),
...
\mst_exec_state[2]_i_11\: unisim.vcomponents.LUT6
    generic map(
...
\reg_pixels[7]_i_6\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFD"
        ...
        port map (
      I0 => Inst_scancode_ascii_n_16,
      I1 => Inst_scancode_ascii_n_5,
