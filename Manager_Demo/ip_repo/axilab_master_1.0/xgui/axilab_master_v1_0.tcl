...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "C_M00_AXI_BUTTON_BASE_ADDR"
  ipgui::add_param $IPINST -name "C_M00_AXI_LED_BASE_ADDR"

}

proc update_PARAM_VALUE.C_M00_AXI_BUTTON_BASE_ADDR { PARAM_VALUE.C_M00_AXI_BUTTON_BASE_ADDR } {
	# Procedure called to update C_M00_AXI_BUTTON_BASE_ADDR when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_M00_AXI_BUTTON_BASE_ADDR { PARAM_VALUE.C_M00_AXI_BUTTON_BASE_ADDR } {
	# Procedure called to validate C_M00_AXI_BUTTON_BASE_ADDR
	return true
}

proc update_PARAM_VALUE.C_M00_AXI_LED_BASE_ADDR { PARAM_VALUE.C_M00_AXI_LED_BASE_ADDR } {
	# Procedure called to update C_M00_AXI_LED_BASE_ADDR when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_M00_AXI_LED_BASE_ADDR { PARAM_VALUE.C_M00_AXI_LED_BASE_ADDR } {
	# Procedure called to validate C_M00_AXI_LED_BASE_ADDR
	return true
}
...
proc update_MODELPARAM_VALUE.C_M00_AXI_BUTTON_BASE_ADDR { MODELPARAM_VALUE.C_M00_AXI_BUTTON_BASE_ADDR PARAM_VALUE.C_M00_AXI_BUTTON_BASE_ADDR } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_M00_AXI_BUTTON_BASE_ADDR}] ${MODELPARAM_VALUE.C_M00_AXI_BUTTON_BASE_ADDR}
}

proc update_MODELPARAM_VALUE.C_M00_AXI_LED_BASE_ADDR { MODELPARAM_VALUE.C_M00_AXI_LED_BASE_ADDR PARAM_VALUE.C_M00_AXI_LED_BASE_ADDR } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_M00_AXI_LED_BASE_ADDR}] ${MODELPARAM_VALUE.C_M00_AXI_LED_BASE_ADDR}
}
